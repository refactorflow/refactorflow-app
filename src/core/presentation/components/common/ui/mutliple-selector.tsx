...
import { Command, CommandGroup, CommandItem, CommandList } from '@/core/presentation/components/common/ui/command';
  ...
  (
    ...
    return (
      <Command
        ...
        shouldFilter={commandProps?.shouldFilter === undefined ? !onSearch : commandProps.shouldFilter} // When onSearch is provided, we don't want to filter the options. You can still override it.
